...
(
  ...
  let firstName = null;
  firstName = 'David';
  buffer.push('\n    ', escape(((stack.linenb = 49), firstName)));
  buffer.push('\n\n\n    ');
  let num = null;
  num = [1, 2, 3];
  buffer.push('\n    ');
  for (const i of num) {
    buffer.push('\n    <p>', escape(((stack.linenb = 54), i)));
    buffer.push('</p>\n    ');
  }
  buffer.push('\n\n\n    ');
  let n = null;
  ...
  buffer.push('\n    ');
  while (n < 10) {
    buffer.push('\n      <p>Hello the number is: ', escape(((stack.linenb = 60), n)));
    buffer.push('</p>\n    ');
    n += 3;
    buffer.push('\n    ');
  }
  buffer.push(
    ...
    escape(((stack.linenb = 65), name)),
  );
  buffer.push(
    '" />\n      <input type="text" name="email" placeholder="Email" value="',
    escape(((stack.linenb = 66), email)),
  );
  buffer.push(
